...
public class BulletTwo extends Pane {
    Image imageUp = new Image("assets/bulletRed_up.png");
    Image imageDown = new Image("assets/bulletRed_down.png");
    Image imageLeft = new Image("assets/bulletRed_left.png");
    Image imageRight = new Image("assets/bulletRed_right.png");
    ImageView imageView;
    String position;
